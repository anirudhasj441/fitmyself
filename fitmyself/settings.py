"""
Django settings for fitmyself project.
...
SECRET_KEY = '-8qpshl9sfdb0bzs5vv-qe=3h7_%0jutzv-(fxy^f%u!51!i#x'
...
WSGI_APPLICATION = 'fitmyself.wsgi.application'
ASGI_APPLICATION = 'fitmyself.asgi.application'
